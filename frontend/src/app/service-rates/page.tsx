    ...
    <AppLayout>
      <div className="space-y-6">
        <div className="flex flex-wrap items-center justify-between gap-4">
          <div>
            <h1 className="font-display text-3xl text-primary">Hizmet Hizmet Tarifelerii</h1>
            <p className="text-muted-foreground">Cilt hizmeti, restorasyon ve acil hizmet tarifeleri</p>
          </div>
              ...
              <form onSubmit={handleCreate} className="grid gap-4 sm:grid-cols-2">
                <div className="space-y-2 sm:col-span-2">
                  ...
                  <Input
                    ...
                    required
                    placeholder="Örn: Kutu Cilt — Standart"
                  />
                </div>
