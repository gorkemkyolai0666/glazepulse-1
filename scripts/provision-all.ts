#!/usr/bin/env tsx
/**
 * GlazePulse infrastructure provisioning orchestrator.
 * Idempotent — safe to run multiple times.
 */

const GITHUB_REPO = process.env.GITHUB_REPO || 'gorkemkyolai06/glazepulse';

async function main() {
  console.log('════════════════════════════════════════════════════════');
  console.log('GlazePulse Infrastructure Provisioning');
